...
TRACE_EVENT(pblk_chunk_state,
	...
	TP_printk("dev=%s ch=%llu lun=%llu chk=%llu state=%s", __get_str(name),
			(u64)(((struct ppa_addr *)(&__entry->ppa))->m.ch),
			(u64)(((struct ppa_addr *)(&__entry->ppa))->m.lun),
